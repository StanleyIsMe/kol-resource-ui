  ...
  <b-card no-body class="bg-default shadow">
    <b-card-header class="bg-transparent border-0">
      <b-row align-v="center" slot="header">
        <b-col cols="8">
          <!-- <h3 class="mb-0 text-white">Tags</h3> -->
        </b-col>
      </b-row>
      <b-row>
        <b-form @submit.prevent="listTags">
          <div class="pl-lg-4 align-items-center">
            <b-row>
              ...
              <b-col lg="6">
                <!-- <b-col cols="4" > -->
                <b-button size="lg" type="submit" variant="primary" class="mt-4">Search</b-button>
                <!-- </b-col> -->
              </b-col>
            </b-row>
            <!-- <b-row>
      ...
      <b-row>
        <validation-observer
            ...
            <b-row>
              ...
              <b-col cols="4">
                <!-- <b-col cols="4" > -->
                    <b-button type="submit" variant="primary" class="mt-4">Create</b-button>
                <!-- </b-col> -->
              </b-col>
            </b-row>
